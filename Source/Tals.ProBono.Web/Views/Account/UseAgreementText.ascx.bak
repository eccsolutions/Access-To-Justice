...
<div>
    ...
    <p>
        Attorneys licensed in Mississippi will be authorized to use the system and to respond to user requests.</p>
    <p>
    ...
    <p>
       The attorney will respond based on Mississippi and/or federal law.</p>
    <p>
        Attorneys may decline to respond to questions. If no attorney responds to a question after fourteen (14) days, the question will be removed and MVLP will notify the user.</p>
    <p>Users will not know the name of the attorney who answers their question.</p>

    <p class="bold">
        Attorney/Client Relationship</p>
    <p>
        This is a Pro Bono Limited Legal Services program administered by MVLP pursuant to Rule 6.5 of the Rules of Professional Conduct.</p>
    ...
    <p>
        There is no attorney/client relationship between the client and MVLP.</p>
    ...
    <p class="bold">
        Agreement</p>
    <p>
        If you do not agree to the terms and conditions of the Mississippi Legal Help Online website, you will not be able to use the system.</p>
