...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    SC Law Answers - Attorney Sign Up FAQ
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        <strong>How does SCLawAnswers work?</strong></p>
<p>SCLawAnswers is based on the Ask-A-Lawyer model where clients request brief advice and counsel about a specific civil legal issue from a volunteer lawyer. Lawyers provide information and basic legal advice without any expectation of long-term representation.</p>
<p>Users who meet eligibility (see Eligibility below) sign the use agreement , create a username and password, post a request for legal advice information and provide facts about their case that will help the lawyer answer the question. Users will be asked to select a category (such as “housing” or “debt”) that best describes their question. The lawyer may ask for additional information before responding to the user’s request, but the user will have a choice to respond to that request or not. Users will provide their name, but no other identifying information will be shared with the volunteer lawyer. Users are informed that there is no guarantee that a question will be answered. If a question is not answered within 30 days, the user will receive an email from the website administrator instructing them to seek assistance elsewhere. The user will also be provided with a list of additional resources.</p>
<p>Lawyers who would like to participate must create a username and password, provide contact information and their Bar number, sign the lawyer use agreement and request approval from the website administrator. Before the lawyer’s account is activated, the website administrator checks to ensure the lawyer is licensed in South Carolina and is in good standing with the South Carolina Bar. Once a lawyer has been approved by the website administrator, the lawyer receives an email notification and can begin answering user questions.</p>
<p>Lawyers may log in at any time to review a list of user questions and select the one(s) they want to answer. Lawyers will use the categories provided by the user (such as “housing” or “consumer”) to help determine which questions they would like to answer. A lawyer will have the opportunity to read the full question before deciding to take it from the list and answer it. Once a lawyer takes a question from the list, the lawyer has 3 days to answer it. Lawyers will be allowed to ask follow up questions via email if they need additional information in order to answer the user’s question. The lawyer’s identity is not revealed to the user unless the lawyer decides to do so. Once a lawyer answers a question, the user will be asked to accept the answer or send a follow up question to the lawyer.</p>
<p>Lawyers will be able to view a log of questions they have answered.</p>
        <strong>Who is eligible to use SCLawAnswers?</strong></p>
  <p>Eligibility for use of SCLawAnswers is limited to the following:</p>
•	The user must have household income less than 250% of the federal poverty level;<br>
•	The user may not have liquid assets exceeding $5,000 in value (this includes checking and savings account balances, as well as the value of any stocks or bonds);<br>
•	The user may not be incarcerated;<br>
•	The user may not request assistance with criminal law matters.<br>
•	The user may not have already hired an attorney<br>
...
<p>Users agree to post no more than 3 legal questions per year.</p>
    ...
    <p>
       A lawyer might be unable to answer a user’s question for a number of reasons. Some examples might be a conflict of interest, user’s failure to respond to lawyer requests for additional information or the question is determined to fall outside the lawyer’s area of expertise. .Lawyers will have access to online resources on various areas of substantive law to help them answer questions via the Pro Bono volunteer site. If a lawyer determines that (s)he cannot answer a question, the lawyer may contact the site administrator to place the question back into the queue so that another volunteer lawyer may try to assist the user. The lawyer should let the administrator know the reason why the question needs to be placed back in the queue.</p>
    <p>
    ...
    <p>
       The only conflicts of interest that would preclude a lawyer from answering a question for an eligible user of SCLawAnswers are conflicts of interest that the lawyer actually knows of at the time that they receive or answer a client’s question. This means that the possibility exists, and the clients agree that they understand, that a lawyer who answers a question, or another lawyer with whom they practice in a firm, may actually be representing other parties with an interest in the question. The user’s name will be provided to the lawyer so that the lawyer can make sure not to answer the question if the lawyer knows that (s)he would have a conflict of interest. If based on the information the user provides, whether user name or any details of the question, the lawyer actually knows of a conflict of interest precluding him from answering, the question will be referred to another volunteer lawyer.</p>
    <p>
        <strong>What about professional liability insurance coverage?</strong></p>
    <p>
       Volunteer lawyers who provide brief advice and counsel via the website will be covered by professional liability insurance maintained by The S.C Bar Pro Bono Program.  If an issue of malpractice arises, SCBPBP can trace each answered question back to the attorney who answered it. SCBPBP may have to contact lawyers participating in the program from time to time related to this insurance coverage.</p>
    <p>
        <strong>Is there a confidentiality issue with client information/lawyer advice being
            housed on the internet?</strong></p>
    <p>
        This site is designed to insure client privacy. Since the web program is administered via email through a platform that limits access based on a screening, confidentiality will be maintained since only the website administrator has access to content between a client and a lawyer. Information available to the website administrator and the lawyer responding to a client request shall remain confidential.  However, client requests for information and the response of the lawyers participating in SCLawAnswers may be maintained in a database for review in order to measure the effectiveness of the project. Steps will be taken to maintain the security of this database and it will only be utilized by the administrator but an absolute guarantee of security is not possible when using the internet and internet based systems.</p>
    <p>
        For each visitor to the Webpage the web server automatically recognizes only the consumer domain name. This is the information that is collected for statistical purposes.</p>
    <p>
    ...
    <p>
        When your account has been approved by the website administrator, you will receive a notification email. To get started you will go to www.SCLawAnswers.org and select “Sign In” at the top right side of your screen. After you enter your username and password, you will automatically be directed to a page that lists all the questions that have been posted for lawyers to answer. 
    </p>
    <p>
    ...
    <p>
       Once you have taken the question, you will be able to reply to the client and provide an answer or ask follow up questions. The client will not know your identity unless you choose to provide it. If you ask the client a question, you will receive an email when the client responds and a prompt to log back into the website to respond.</p>
    <p>
        <strong>How Do I Subscribe to a Category</strong></p>
    <p>
        If your area of practice is specialized and you only want to answer certain types of questions, you can subscribe to a Category and receive an email notification each time a question in that particular Category is posted.</p>
    <p>
    ...
    <p>
        <strong>Entering Hours for PB Credit</strong></p>
    <p>
       Each time you attempt to log out of the website, you will be prompted to enter the time you have spent researching and answering questions. You may log your time in 15-minute increments. You may view your hours at any time by clicking on “My Profile” at the top of the page.
    </p>
    <p>
        <strong>How do I contact the administrator with a question?</strong></p>
    <p>
        If you have a question or run into a technical problem with the site, you may contact the administrator by clicking on the “Help” link located at the bottom of the page.</p>
    <% if (!Request.IsAuthenticated) %>
    <% { %>
