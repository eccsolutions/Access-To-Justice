...
<ul>
    ...
    <li>The lawyer only helps you with the question you type into this website. No other services should be expected from the lawyer.</li>
    <li>The Lawyers may take on your case for a $75 per hour fee but are under no obligation. To continue working together is outside the purpose of this system and should not be expected. Lawyers will indicate if that is an option for you.</li>    
    <li>
        Unless offered by the lawyer this means:
        <ul>
    ...
    <li>The lawyer only tells you Arizona law. Laws may be different in other states.</li>
    <li>All volunteer lawyers using this system can see what you ask in your question.</li>
    ...
    <li>The people who run this website do not provide legal advice.</li>
