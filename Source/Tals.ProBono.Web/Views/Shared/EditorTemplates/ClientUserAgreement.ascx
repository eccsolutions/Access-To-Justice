...
<div id="UserAgreement">
    ...
    <ol>
	    <li>You do not already have a lawyer helping you with this problem.</li>
  		<li>You have answered the eligibility questions truthfully</li>
		<li>You must tell the truth about your problem.</li>
