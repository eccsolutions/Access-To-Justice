...
<asp:Content ID="aboutContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>The <%=ConfigSettings.SiteName %> is administered by the Arizona Foundation for Legal Services &amp; Education, under the Legal LEARN Contact Center, a joint program with the Arizona State Bar, in partnership with the Volunteer Lawyers Programs of Community Legal Services, Southern Arizona Legal Aid and DNA People&#39;s Legal Services. Special thanks to the Supreme Court of Arizona, the Arizona Department of Veterans Services, Baker, Donelson, Bearman, Caldwell & Berkowitz, Tennessee Alliance for Legal Services, DNA People&#39;s Legal Services, Southern Arizona Legal Aid, Community Legal Services and our other Arizona partner organizations and stakeholders for their critical support of this project. These entities share the goal of increasing access to legal services to those who cannot afford it.</p>
